...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'http://localhost', 'https://localhost', 'transcendence', 'pong', 'colorwar',]
CSRF_TRUSTED_ORIGINS = ['https://localhost', 'http://pong', 'http://colorwar']
